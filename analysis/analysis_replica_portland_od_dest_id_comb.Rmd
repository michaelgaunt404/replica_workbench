...
selected_geoms = read_rds(here("data/geo_tracts_analysis_20220810/selected_geoms.RDS"))
```
...
# 
# what_we_created = map@map %>%  
#   mapedit::editMap()
# 
# what_we_created$all %>%  mapview()
# 
# saveRDS(what_we_created
#         ,here("data/geo_tracts_analysis_20220810/selected_geoms.RDS"))
# 
